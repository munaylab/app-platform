...
class BalanceServiceSpec extends Specification
    ...
    void '[BalanceService] - agregar egreso'() {
        given:
    ...
    void '[BalanceService] - modificar egreso'() {
        given:
    ...
    void '[BalanceService] - cancelar egreso'() {
        given:
    ...
    void '[BalanceService] - modificar ingreso'() {
        given:
    ...
    void '[BalanceService] - cancelar ingreso'() {
        given:
    ...
    void '[BalanceService] - crear categoria'() {
        when:
        service.actualizarCategoria(Builder.categoriaIngresoCommand)
        then:
        Categoria.count() == 1
    }
    void '[BalanceService] - crear subcategoria'() {
        given:
    ...
    void '[BalanceService] - modificar categoria'() {
        given:
        Builder.crearCategoria().save(flush: true)
        def command = Builder.categoriaIngresoCommand
        command.id = 1
