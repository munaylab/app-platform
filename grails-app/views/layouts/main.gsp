  ...
  <aside class="bg-dark" id="contacto">
    <div class="container">
      ...
      <div class="row visible-xs-block text-center">
        <a href="tel:+54903884381969" class="col-xs-6 text-center">
            <i class="fa fa-phone fa-2x"></i>
            <p>+54 9 03884381969</p>
        </a>
        <a href="mailto:contacto@munaylab.org" class="col-xs-6 text-center">
          <i class="fa fa-envelope-o fa-2x"></i>
          <p>contacto@munaylab.org</p>
        </a>
      </div>
      <div class="row visible-xs-block">
        <a href="https://www.facebook.com/munaylab" class="col-xs-6 text-center">
          <i class="fa fa-facebook fa-2x"></i>
          <p>MunayLab</p>
        </a>
        <a href="https://twitter.com/MunayLab" class="col-xs-6 text-center">
          <i class="fa fa-twitter fa-2x"></i>
          <p>@MunayLab</p>
        </a>
      </div>
